...
namespace UsuarioEx.Controllers
{
    public class DisciplinasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Cargahoraria,Login,Password,Salario,Formação")] Disciplinas disciplinas)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Cargahoraria,Login,Password,Salario,Formação")] Disciplinas disciplinas)
        {
