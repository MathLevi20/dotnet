...
namespace UsuarioEx.Controllers
{
    public class PessoasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Login,Password")] Pessoas pessoas)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Login,Password")] Pessoas pessoas)
        {
            if (id != pessoas.Id)
            {
                return NotFound();
