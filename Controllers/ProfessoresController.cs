...
namespace UsuarioEx.Controllers
{
    public class ProfessoresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Login,Password,Salario,Formação")] Professores professores)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Login,Password,Salario,Formação")] Professores professores)
        {
